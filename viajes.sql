...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-10-2017 a las 03:44:18
...
CREATE TABLE IF NOT EXISTS `cheque` (
  ...
  `aTercero` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_cheque`),
  KEY `originante` (`originante`),
  KEY `destinatario` (`destinatario`),
  KEY `aTercero` (`aTercero`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
ALTER TABLE `movimiento`
  ADD CONSTRAINT `movimiento_ibfk_1` FOREIGN KEY (`empresa`) REFERENCES `empresa` (`id_empresa`),
  ADD CONSTRAINT `movimiento_ibfk_2` FOREIGN KEY (`chofer`) REFERENCES `chofer` (`id_chofer`);

--
-- Filtros para la tabla `viaje`
--
ALTER TABLE `viaje`
  ADD CONSTRAINT `viaje_ibfk_1` FOREIGN KEY (`origen`) REFERENCES `chofer` (`id_chofer`),
  ADD CONSTRAINT `viaje_ibfk_2` FOREIGN KEY (`destino`) REFERENCES `chofer` (`id_chofer`),
